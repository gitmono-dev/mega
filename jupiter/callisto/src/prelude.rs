...
pub use super::{
    ...
    namespace_node::Entity as NamespaceNode, non_member_note_views::Entity as NonMemberNoteViews,
    note_views::Entity as NoteViews, notes::Entity as Notes,
    ...
    snapshot_instance::Entity as SnapshotInstance, snapshot_source::Entity as SnapshotSource,
