...
use crate::api::{
    ...
    router::{
        ...
        group_router, issue_router, label_router, merge_queue_router, orion_image_router,
        orion_runner_router, permission_router, preview_router, repo_router, reviewer_router,
...
pub fn routers() -> OpenApiRouter<MonoApiServiceState> {
    OpenApiRouter::new()
        ...
        .merge(orion_image_router::routers())
}
