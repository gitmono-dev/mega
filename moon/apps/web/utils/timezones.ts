export const timezones = [
  ...
  },
  {
    ...
    utc: ['America/Vancouver', 'America/Los_Angeles', 'America/Tijuana', 'PST8PDT']
  },
  {
  ...
  },
  {
    ...
    utc: ['UTC', 'America/Danmarkshavn', 'Etc/GMT']
  },
  {
...
export const timezonePickerOptions = timezones
  .map((tz) => ({
    value: tz.utc[0],
    label: tz.text,
    key: tz.text
  }))
  // these seem generally less useful?
  .filter((tz) => !tz.label.startsWith('Etc'))
  // remove duplicates
