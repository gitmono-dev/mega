...
export function PendingAccountReviewButton() {
  ...
  return (
    <div className='relative'>
      ...
      />
      <span className='pointer-events-none absolute -top-0.5 -right-0.5 flex h-4 min-w-4 items-center justify-center rounded-full bg-amber-500 px-1 font-mono text-[10px] leading-none font-bold text-white'>
