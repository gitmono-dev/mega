...
export const Link = forwardRef<HTMLAnchorElement, LinkProps>((props, ref) => {
  ...
  const desktopOnClickOverride = isDesktopApp && (type === 'desktop_oauth' || type === 'public_share')
    ...
    <NextLink
      ...
      onClick={(e) => {
        if (desktopOnClickOverride) {
          if (type === 'desktop_oauth' || type === 'public_share') {
           ...
           * Unfortunately, when we open a window programmatically with ToDesktop,
