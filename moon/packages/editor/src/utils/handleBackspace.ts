...
export const handleBackspace = (editor: Editor, name: string, parentListTypes: string[]) => {
  ...
  const previousListItemHasSubList = listHelpers.listItemHasSubList(name, editor.state, prevNode)

  // if the previous item is a list item and doesn't have a sublist, join the list items
  if (listHelpers.hasListItemBefore(name, editor.state) && !previousListItemHasSubList) {
